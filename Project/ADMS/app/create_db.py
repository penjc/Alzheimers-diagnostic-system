...
from app.models import User, Admin, Expert, MRI, DApplication, EAchievement, Resu, Pred, JApply, Visibility
...
def add_Admin():
    ...
    """
    # 声明对象
    admin = Admin(a_id='9999999', a_pwd='123456a', a_name='高子琪', a_sex='女', a_birth='2001-08-14', a_phone='15164578613')
    # 调用添加方法
...
def add_Expert():
    ...
    :return:
    """
    expert = Expert(e_id='1234567', e_pwd='abcdefg', e_name='朱明枞', e_sex='女', e_birth='1999-02-08', e_phone='15021823663')
