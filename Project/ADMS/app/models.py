...
class User(db.Model):
    __tablename__ = 'user'
    u_id = db.Column(db.String(30), nullable=False)
    u_pwd = db.Column(db.String(30), nullable=False)
    u_name = db.Column(db.String(30), primary_key=True, nullable=False)
...
class Visibility(db.Model):
    ...
    user_id = db.Column(db.String(30), db.ForeignKey('user.u_id'), primary_key=True, nullable=False)
    expert_id = db.Column(db.String(30), db.ForeignKey('expert.e_id'), nullable=False)
    visible = db.Column(db.Boolean, nullable=False, default=True)

    def __init__(self, user_id, expert_id, visible=True):
...
class JApply(db.Model):
    ...
    j_resume = db.Column(db.String(100), unique=True, nullable=False)
